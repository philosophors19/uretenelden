    ...
    <div className="bg-[#F8F1E5] text-gray-900 font-sans relative min-h-screen">
      ...
      <div className="relative z-10">
        <section id="catalog" className="relative text-white py-12 px-4 sm:px-6 lg:px-24">
          <h2 className="relative text-3xl sm:text-5xl font-bold text-center mb-12 sm:mb-16 bg-cover bg-center py-16 sm:py-24 text-white rounded-2xl overflow-hidden shadow-2xl" style={{ backgroundImage: `url('/catalog-sebzemeyve.jpg')` }}>
